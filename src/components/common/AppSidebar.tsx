...
export function AppSidebar() {
  ...
  return (
    ...
    >
      <SidebarHeader
        className={cn(
          'flex md:pt-2 bg-transparent',
          isCollapsed
            ? 'flex-row items-center justify-between gap-y-2 md:flex-col md:items-center md:justify-center'
      ...
      >
        ...
        <div
          className={cn(
            'px-2 pb-2',
            isCollapsed && 'px-0 flex justify-center pt-1'
          )}
        >
          <Button
            onClick={() => {
            ...
            className={cn(
              'cursor-pointer shadow-sm text-xs',
              ...
              isCollapsed
                ...
                : 'w-full justify-start rounded-md h-8'
            )}
          >
            <Plus className={cn('h-3.5 w-3.5', !isCollapsed && 'mr-2')} />
